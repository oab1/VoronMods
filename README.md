...
however I did have to add two holes to the back panel (1.5" diameter) for the blower inlets. Pellets need to be replaced every so often, have heard anywhere from 50-100 hours. Have not run that long myself yet.
